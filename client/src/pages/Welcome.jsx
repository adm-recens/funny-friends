...
import { Trophy, ArrowRight, Play, User, History, Settings, Users, Eye, Shield, LogIn } from 'lucide-react';
...
const Welcome = () => {
    ...
    const [viewMode, setViewMode] = useState(null); // null, 'operator', 'viewer'
    ...
    const handleViewerJoin = async (e) => {
        ...
        try {
            ...
            // Navigate to viewer page with credentials
                ...
                <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full">
                    ...
                    <form onSubmit={handleOperatorLogin} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-blue-500/30 transition-all disabled:opacity-50"
                        >
    ...
    if (viewMode === 'viewer') {
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
                ...
                <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full">
                    <div className="text-center mb-8">
                        <div className="w-16 h-16 bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-2xl mx-auto mb-4 flex items-center justify-center">
                    ...
                    <form onSubmit={handleViewerJoin} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-emerald-500/30 transition-all disabled:opacity-50"
                        >
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-12">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl rotate-3 flex items-center justify-center shadow-lg shadow-yellow-500/20">
                            <Trophy size={24} className="text-white -rotate-3" />
                        </div>
                        <h1 className="text-3xl font-black text-white tracking-tight">
                            Teen <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-200">Patti</span> <span className="text-xs text-slate-500 ml-2">v2.0</span>
                        </h1>
                    </div>
                ...
                {!user && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        ...
                        <button 
                            ...
                            className="group bg-gradient-to-br from-blue-900/50 to-blue-800/30 hover:from-blue-800/50 hover:to-blue-700/30 border border-blue-500/30 rounded-2xl p-8 text-left transition-all duration-300 hover:-translate-y-1"
                        >
                            <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl mb-6 flex items-center justify-center shadow-lg shadow-blue-500/30 group-hover:scale-110 transition-transform">
                                <Users className="text-white" size={28} />
                            </div>
                            <h3 className="text-2xl font-black text-white mb-2">Operator</h3>
                            <p className="text-blue-200 mb-4">Login to create and manage game sessions</p>
                        ...
                        >
                            <div className="w-14 h-14 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-xl mb-6 flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
                        {user?.role === 'OPERATOR' ? 'Your Games' : 'Live Games'}
                    </h2>
