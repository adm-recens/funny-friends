    ...
    const createSession = async () => {
        ...
        try {
            const res = await fetch(`${API_URL}/api/sessions`, {
                method: 'POST',
                headers,
                body: JSON.stringify({ name: sessionName, totalRounds: parseInt(totalRounds), players: [] }),
                credentials: 'include'
            });
            ...
            <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl p-8 border border-slate-100">
                ...
                <div className="space-y-6">
                    ...
                    <button
                        ...
                        className="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-bold text-xl shadow-xl shadow-blue-500/30 transition-all active:scale-[0.98]"
                    >
